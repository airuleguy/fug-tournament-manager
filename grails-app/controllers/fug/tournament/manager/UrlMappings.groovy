...
class UrlMappings {
    ...
    static mappings = {
        ...
        name listScores: "/tournaments/$tournamentId/scores"(controller: "score")
        name showScore: "/tournaments/$tournamentId/scores/$id"(controller: "score", action: "show")
        name editScore: "/tournaments/$tournamentId/scores/$id/edit"(controller: "score", action: "edit")
        name deleteScore: "/tournaments/$tournamentId/scores/$id/delete"(controller: "score", action: "delete")
        name createScore: "/tournaments/$tournamentId/scores/create"(controller: "score", action: "create")
        name saveScore: "/tournaments/$tournamentId/scores/save"(controller: "score", action: "save")
        name updateScore: "/tournaments/$tournamentId/scores/$id/update"(controller: "score", action: "update")
