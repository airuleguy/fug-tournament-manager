...
<html>
    ...
    <body>
        ...
        <div id="show-exercise" class="content scaffold-show" role="main">
            ...
            <f:display bean="exercise" />
            <g:form resource="${this.exercise}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.exercise}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
