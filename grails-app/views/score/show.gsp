    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="list" action="index" uri="/gymnastics/tournaments/${tournament.id}/scores"><g:message code="default.list.label" args="[entityName]" /></g:link></li>
        ...
        <div id="show-score" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.score}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" uri="/gymnastics/tournaments/${tournament.id}/scores/edit" resource="${this.score}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
